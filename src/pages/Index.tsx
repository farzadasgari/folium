            ...
            <>
                {() => {
                    return `
                        ...
                        via-purple-950 via-blue-950 via-emerald-950 via-red-950 via-yellow-950 via-pink-950 via-rose-950 via-cyan-950
                        ...
                        from-purple-400/20 to-purple-600/20 from-blue-400/20 to-blue-600/20 from-emerald-400/20 to-emerald-600/20 from-red-400/20 to-red-600/20 from-yellow-400/20 to-yellow-600/20 from-pink-400/20 to-pink-600/20 from-rose-400/20 to-rose-600/20 from-cyan-400/20 to-cyan-600/20
                        ...
                        group-hover:text-purple-400 group-hover:text-red-400 group-hover:text-blue-400 group-hover:text-emerald-400 group-hover:text-rose-400 group-hover:text-yellow-400 group-hover:text-pink-400 group-hover:text-cyan-400
                        dark:group-hover:text-purple-200 dark:group-hover:text-red-200 dark:group-hover:text-blue-200 dark:group-hover:text-emerald-200 dark:group-hover:text-rose-200 dark:group-hover:text-pink-200 dark:group-hover:text-cyan-200 dark:group-hover:text-yellow-200
                        bg-purple-200 bg-red-200 bg-blue-200 bg-emerald-200 bg-cyan-200 bg-yellow-200 bg-rose-200 bg-pink-200
                        hover:bg-purple-300 hover:bg-red-300 hover:bg-blue-300 hover:bg-emerald-300 hover:bg-cyan-300 hover:bg-yellow-300 hover:bg-rose-300 hover:bg-pink-300
                        text-purple-900 text-red-900 text-blue-900 text-emerald-900 text-cyan-900 text-yellow-900 text-rose-900 text-pink-900
                        border-purple-200 border-red-200 border-blue-200 border-emerald-200 border-cyan-200 border-yellow-200 border-rose-200 border-pink-200
                        dark:hover:text-purple-200 dark:hover:text-red-200 dark:hover:text-blue-200 dark:hover:text-emerald-200 dark:hover:text-cyan-200 dark:hover:text-yellow-200 dark:hover:text-rose-200 dark:hover:text-pink-200
                        `;
                }}
            </>
        </div>
