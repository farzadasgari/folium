        ...
        relative overflow-hidden w-full">
            <div className="text-center z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <button className="cursor-pointer bg-gradient-to-r from-purple-500 to-purple-700
                    ...
                    <button className="cursor-pointer border-2 border-purple-400 text-purple-400
