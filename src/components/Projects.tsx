    ...
    const projects = [
        {
            ...
            topics: ["Python", "Signal Processing", "Fluid Dynamics", "Scientific Computing"],
            liveURL: "#",
            githubURL: "#",
        },
        {
            ...
            topics: ["JavaScript", "WebGL", "Data Visualization", "Computational Fluid Dynamics"],
            liveURL: "#",
            githubURL: "#",
        },
        {
        ...
        },
        {
            ...
            topics: ["R", "Time Series Analysis", "Environmental Science", "Statistics"],
            liveURL: "#",
            githubURL: "#",
        },
        {
            ...
            topics: ["C++", "3D Modeling", "Point Clouds", "Geospatial Analysis"],
            liveURL: "#",
            githubURL: "#",
        },
    ];
