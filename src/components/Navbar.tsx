            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {['home', 'about', 'skills', 'projects', 'contact'].map(
                            (item) => (
                                <button
                                    ...
                                    className="capitalize text-slate-800 hover:text-purple-400 
                                    dark:text-slate-200 dark:hover:text-purple-300 
                                ...
                                >
                                    ...
                                    group-hover:bg-purple-400 dark:group-hover:bg-purple-300 
                ...
                {isMenuOpen && (
                    <div
                        ...
                        rounded-lg mt-2 border border-purple-400/20 backdrop-blur-md"
                    >
                        <div className="flex flex-col space-y-4 px-4">
                            {[
                                ...
                                <button
                                    key={item}
                                    onClick={() => scrollToSection(item)}
                                    className="capitalize text-left py-2 text-slate-800 hover:text-purple-400 
                                        dark:text-slate-200 dark:hover:text-purple-300
